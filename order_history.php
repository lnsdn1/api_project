...
$sql = "SELECT oi.*, o.uContact FROM order_items oi 
...
<head>
    <meta charset="UTF-8">
    <title>Beyond D' Crust - orders</title>
...
<body>
    ...
    <div class="content">
        <div class="container px-5 py-5">
            ...
            <div class="card">
                <div class="card-body">
                    <center><h5 class="card-title">Your Orders</h5></center>
                    <?php if ($result->num_rows > 0): ?>
                        <ul class="list-group mb-4">
                            <?php while($row = $result->fetch_assoc()): ?>
                                <li class="list-group-item">
                                    <h6><b>Order ID:</b> <?php echo $row['order_id']; ?></h6>
                                    ...
                                    <p><b>Ordered At:</b> <?php echo $row['created_at']; ?></p>
                                </li>
                            <?php endwhile; ?>
                        </ul>
                    <?php else: ?>
